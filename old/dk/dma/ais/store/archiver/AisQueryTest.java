 ...
 */
public class AisQueryTest extends AbstractDaemon {

    @Parameter(names = "-store", description = "A list of cassandra hosts that can store the data")
    List<String> cassandraSeeds = Arrays.asList("localhost"/* "10.10.5.202" */);
    ...
    protected void runDaemon(Injector injector) throws Exception {
        ...
        AisStore mqs = new CassandraAisStore(con);
